...
echo "seqgmentation"
$cnvkit segment "$odir"/"$test_sample".cnr -m cbs -o "$odir"/"$test_sample".cns

echo "CNV calling"
$cnvkit call "$odir"/"$test_sample".cns -o "$odir"/"$test_sample".call.cns
...
$cnvkit scatter "$odir"/"$test_sample".cnr -s "$odir"/"$test_sample".cns -o "$odir"/"$test_sample"-scatter.pdf
